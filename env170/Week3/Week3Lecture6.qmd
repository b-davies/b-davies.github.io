...
-   Start up R Studio and open a new script. Load the **palmerpenguins** and **gapminder** packages (install them if needed)
...
-   For this activity, use the **penguins** dataset to plot some of the data. Use at least 3 variables in your plot.
